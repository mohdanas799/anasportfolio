...
const Navbar = () => {
  ...
  return (
    <header className="w-full px-28 py-8 font-medium flex  items-center justify-between 
...

    {
      ...
      bg-dark/90 dark:bg-light/80 rounded-lg backdrop-blur-md py-32
      ">
      <nav className="flex items-center flex-col justify-center">
         ...
         <CustomMobileLink href="/project" title="Project" className="" toggle={handelClick} />
